...
public class AppliedCustomerBillingRate   {
  ...
  **/
  ...
  /**
   * A list of applied billing rate characteristics. An applied billing rate has dynamic characteristics according to the its billType (characteristics are based on the service billType, line of business or on others parameters for example)
   * @return characteristic
  **/
  @ApiModelProperty(value = "A list of applied billing rate characteristics. An applied billing rate has dynamic characteristics according to the its billType (characteristics are based on the service billType, line of business or on others parameters for example)")
