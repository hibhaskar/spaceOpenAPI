...
public class SwaggerConfiguration {
    ...
    public ApiInfo apiInfo() {
    	...
    	return new ApiInfoBuilder()
            .title("API CustomerBillOnDemand")
            .description("##TMF API Reference: TMF 678 - Customer Bill Management  "
            		+ "<br/>"
            		+ "<p><b><u>##Release:</u></b> <br/>pre-release 17.5  The Customer Bill Management API allows to find and retrieve one or "
            		...
            		+ "<br/>-  Create a customer bill on demand request, retrieve one or a collection of  customer bill on demand "
            		+ "request(s) depending on filter criteria.  "
            		+ "<br/>- Manage notification of events on customer bill on demand.  "
            		+ "<br/><br/>"
