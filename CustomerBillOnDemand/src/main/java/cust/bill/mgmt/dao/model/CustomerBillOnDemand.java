 ...
 */
@ApiModel(description = "This resource is used to manage the creation request of a customer bill in real-time "
		+ "(on demand).")
@Validated
@javax.annotation.Generated(
		value = "cust.bill.mgmt.codegen.languages.SpringCodegen", date = "2018-09-29T16:06:28.483+05:30")
//@Table("CustomerBillOnDemand")
public class CustomerBillOnDemand implements Serializable {
	 ...
	 * @param customerBill
	 */
	public CustomerBillOnDemand(String id, String href, String name, String description, StateValues state,
			String lastUpdate, String type, String schemaLocation, BillingAccountRef billingAccount,
			RelatedPartyRef relatedParty, BillRef customerBill) {
		super();
		this.id = id;
		this.href = href;
		this.name = name;
  ...
  **/
  ...
  public void setBillingAccount(BillingAccountRef billingAccount) {
    /*this.billingAccount = new BillingAccountRef(
    		billingAccount.getId(),billingAccount.getHref(),billingAccount.getName(),billingAccount.getType());
    System.out.println("billingAccount??????: "+this.billingAccount);*/
	  this.billingAccount = billingAccount;
  }
