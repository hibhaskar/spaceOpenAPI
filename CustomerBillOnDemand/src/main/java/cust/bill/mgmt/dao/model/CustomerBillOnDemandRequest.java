...
public class CustomerBillOnDemandRequest implements Serializable {
	 ...
	 * @param relatedParty
	 */
	public CustomerBillOnDemandRequest(String name, String description, BillingAccountRef billingAccount,
			RelatedPartyRef relatedParty) {
		super();
		this.name = name;
  ...
  public CustomerBillOnDemandRequest() {
